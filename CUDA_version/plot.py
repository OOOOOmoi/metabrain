...
# 读取数据
group_1_data = read_spike_data('/home/yangjinhao/stucture/CUDA_version/exc_spike_times.txt')
group_2_data = read_spike_data('/home/yangjinhao/stucture/CUDA_version/inh_spike_times.txt')
...
plt.tight_layout()
plt.savefig("/home/yangjinhao/stucture/CUDA_version/EItest.png")
